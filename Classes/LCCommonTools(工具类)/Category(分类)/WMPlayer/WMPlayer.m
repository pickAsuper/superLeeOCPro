...
//        make.width.mas_equalTo(40);
        ...
        make.top.mas_equalTo(ws.bottomView.mas_top);
        make.left.mas_equalTo(ws.bottomView.mas_left);
//        make.height.mas_equalTo(40);
        make.bottom.mas_equalTo(ws.bottomView.mas_bottom);
        make.width.mas_equalTo(40);
    ...
    self.progressSlider.minimumTrackTintColor = [UIColor grayColor];
...
//        make.center.equalTo(self.bottomView);
        ...
        make.left.mas_equalTo(ws.playOrPauseBtn.mas_right).offset(5);
        make.right.mas_equalTo(ws.bottomView).offset(-45);
        make.centerY.mas_equalTo(ws.bottomView.mas_centerY);
...
//        make.center.equalTo(self.progressSlider).with.offset(0.7);
        ...
        make.left.mas_equalTo(ws.progressSlider.mas_left);
        make.right.mas_equalTo(ws.progressSlider.mas_right);
        make.centerY.mas_equalTo(ws.progressSlider.mas_centerY);
...
//    self.leftTimeLabel.backgroundColor = [UIColor orangeColor];
...
//        make.bottom.equalTo(self.bottomView).with.offset(0);
       ...
       make.left.mas_equalTo(ws.progressSlider.mas_left);
        make.top.mas_equalTo(ws.progressSlider.mas_bottom);
        make.bottom.mas_equalTo(ws.bottomView.mas_bottom);
...
//        make.left.mas_equalTo(ws.topView.mas_top).offset(5);
//        make.top.mas_equalTo(ws.topView.mas_left).offset(5);
        make.height.mas_equalTo(40);
        make.width.mas_equalTo(40);
